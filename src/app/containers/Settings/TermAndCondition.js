                    ...
                    <div className='row'>
                        <div className='col-md-12'>
                                ...
                                <i class="fas fa-greater-than termcond "></i>
                                    <p className='dummyText  m-0 ps-2'> Lorem Ipsum has been the industry's standard dummy text ever since.</p>
                                </div>
                                <div className='flexBox '>
                                <i class="fas fa-greater-than termcond "></i>
                                    <p className='dummyText  m-0 ps-2'>  When an unknown printer took a galley of type and scrambled it to make a type specimen book. </p>
                                </div>
                                <div className='flexBox'>
                                <i class="fas fa-greater-than termcond "></i>
                                    <p className='dummyText m-0 ps-2'> It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. </p>
                                </div>
