                    ...
                    <div className='row'>
                        <div className='col-md-12'>
                                <div className='commonInnerHeader d-flex align-items-center mt-4 ms-3'>
                                    ...
                                    <p className='settingMainHeading text-align-center '>Terms & Conditions</p>
                                </div>
                                <div className='termAndCond'>
                                <div className='termcondDummy'>
                                    <p className='innerDummyHeading'>What is Lorem Ipsum?</p>
                                ...
                                <i class="fas fa-greater-than termcond "></i>
                                    <p className='dummyText  ms-2 mt-2'> Lorem Ipsum has been the industry's standard dummy text ever since.</p>
                                </div>
                                <div className='flexBox '>
                                <i class="fas fa-greater-than termcond "></i>
                                    <p className='dummyText  ms-2 mt-2'>  When an unknown printer took a galley of type and scrambled it to make a type specimen book. </p>
                                </div>
                                <div className='flexBox'>
                                <i class="fas fa-greater-than termcond "></i>
                                    <p className='dummyText  ms-2 mt-2'> It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. </p>
                                </div>
